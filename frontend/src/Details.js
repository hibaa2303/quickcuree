...
const Details = () => {
  ...
  const handleAddToCart = (medicine) => {
    try {
      ...
      if (index !== -1) {
        // If medicine is already in cart, increment quantity
      ...
      navigate('/cartdeets'); // Redirect to cart details page
    } catch (error) {
        ...
        <div className='boxx d-flex'>
          ...
          <div className="w-25 box mt-5 ms-4">
            <div className="border border-1 m-lg-2">
                ...
                <div className="px-3">
                  ...
                  >
                    ...
                    <div className="d-flex">
                      ...
                      <h6 className="mt-2">free shipping with Care Plan</h6>
                    </div>
                  </RadioGroup>
                </div>
              </FormControl>
              ...
              <button 
                className="btn btn-warning fs-6 w-75 me-1 ms-4"
                onClick={() => handleAddToCart(medicine)} // Updated to call handleAddToCart
              >
                Add to Cart
              </button>
            ...
            <Carousel>
              ...
              <CarouselItem>
                <div className="container w-100 border shadow">
                  ...
                  <div className="w-25 border-1 mt-5 mb-5"></div>
